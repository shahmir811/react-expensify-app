...
var Options = function Options(props) {
  return React.createElement(
    ...
    props.options.map(function (option) {
      return React.createElement(Option, { key: option, value: option, handleDeleteOption: props.handleDeleteOption });
    })
  );
};
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      { onClick: function onClick(e) {
          return props.handleDeleteOption(props.value);
        } },
      'Remove'
    )
  );
...
var AddOptions = function (_React$Component2) {
  ...
  _createClass(AddOptions, [{
    ...
    value: function handleAddOption(e) {
      e.preventDefault();
      var option = e.target.elements.option.value.trim(); // option is the name of inoput field
